        ...
        try ( var arena = Arena.openConfined() )
        {
            var structLayout = MemoryLayout.structLayout(
                    ...
                    MemoryLayout.structLayout( ValueLayout.JAVA_SHORT.withName( "offset" ) )
                                .withName( "timezone" ) );
            memorySegment = MemorySegment.allocateNative( structLayout, arena.scope() );
            ...
            var timezoneOffsetVarHandler = structLayout.varHandle(
                    groupElement( "timezone" ), groupElement( "offset" ) );
            ...
            var timezoneOffsetmethodHandle = timezoneOffsetVarHandler.toMethodHandle( VarHandle.AccessMode.GET )
            ...
            out.printf( "timezone offset using method handler is volatile access is %d%n", timezoneOffsetmethodHandle.invoke( memorySegment ) );
        }
    }
}
